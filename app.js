...
// ============================================================
const venueConfigs = {
    // ===== SHILLONG ===== (navy blue, matches reference)
    shillong: { 
    ...
    // ===== JUWAI ===== (bright gold/yellow, matches reference)
    juwai: { 
        ...
        if (!error && data && data.length > 0) {
            data.forEach(row => {
                ...
                html += `<tr>
                    ...
                    <td style="padding:8px; font-weight:700; color:${config.textSafeFr || config.colorFr};">${fr}</td>
                    <td style="padding:8px; font-weight:700; color:${config.textSafeSr || config.colorSr};">${sr}</td>
                </tr>`;
            });
        } else {
        ...
        html += `
            <div class="result-card" style="border-left-color: ${color};">
                ...
                <div class="venue-header" style="background: linear-gradient(135deg, ${color}, ${color}dd);">
                    <span class="venue-name" style="color: ${config && config.colorText ? config.colorText : '#ffffff'};">🎯 ${v.name}</span>
                </div>
