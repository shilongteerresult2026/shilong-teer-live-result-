...
// ============================================================
// 🔥 VIP SYSTEM (Timer + Ad + Unlock) - যোগ করা হলো
// ============================================================
document.addEventListener('DOMContentLoaded', function() {
    ...
    // এলিমেন্ট না পেলে ফিরে যান (সব পেজে VIP না থাকতে পারে)
    if (!vipBtn) return;
        ...
        startCountdown(5, async function() {
            try {
                ...
                if (vipNumber) {
                    ...
                    if (vipExtraInfo) vipExtraInfo.innerHTML = '✅ <span style="color:#008000;">VIP Number unlocked successfully!</span>';
                    if (vipStatusText) {
                    ...
                    if (vipExtraInfo) vipExtraInfo.innerHTML = '⚠️ <span style="color:#ff9800;">[Demo Mode]</span>';
                    if (vipStatusText) {
                ...
                if (vipStatusText) {
                    vipStatusText.textContent = '❌ VIP আনলক করতে ব্যর্থ!';
